...
const NewSalePage = () => {
    ...
    const handleUnifiedSearch = useCallback((query) => {
        ...
        if (trimmedQuery.length < 2) { setSuggestions([]); setProductSuggestions([]); setSearching(false); return; }
        setSearching(true);
        searchDebounceRef.current = setTimeout(async () => {
            ...
            try {
                const response = await deviceSearchAPI.search(trimmedQuery, controller.signal);
